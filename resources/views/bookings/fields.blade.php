...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <div class="form-check">
            <input type="checkbox" class="form-check-input" name="is_paid" value="1" {{(isset($booking->is_paid)) && old('is_paid') ?? $booking->is_paid == 1 ? 'checked ' : ' '}} /> <label class="form-check-label" for="start">Pre-Paid</label>
